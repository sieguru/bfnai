    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
      ...
      <div class="bg-white border border-gray-200 rounded-lg p-6">
        ...
        <div class="mt-4 text-xs text-gray-500">
          Avg: {{ stats.chunks.avgTokens }} tokens/chunk
        </div>
      </div>
      ...
      <div class="bg-white border border-gray-200 rounded-lg p-6">
        <div class="flex items-center">
          ...
          <div class="ml-4">
            <p class="text-sm text-gray-500">Vector Store</p>
      ...
      <div class="bg-white border border-gray-200 rounded-lg p-6">
        ...
        <div class="space-y-3">
          ...
          >
            ...
            <span class="font-medium text-blue-700">Upload Document</span>
          </router-link>
          <router-link
            to="/agent"
          ...
          >
            ...
            <span class="font-medium text-green-700">Start New Chat</span>
          </router-link>
          <router-link
            to="/search"
          ...
          >
            ...
            <span class="font-medium text-purple-700">Search Documents</span>
          </router-link>
        </div>
      </div>
